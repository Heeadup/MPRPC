...
class ResultCode : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:fixbug.ResultCode) */ {
 public:
  ...
  void clear_errocode();
  static const int kErrocodeFieldNumber = 1;
  ::google::protobuf::int32 errocode() const;
  void set_errocode(::google::protobuf::int32 value);
...
// optional int32 errocode = 1;
inline void ResultCode::clear_errocode() {
  errocode_ = 0;
}
inline ::google::protobuf::int32 ResultCode::errocode() const {
  // @@protoc_insertion_point(field_get:fixbug.ResultCode.errocode)
  return errocode_;
}
inline void ResultCode::set_errocode(::google::protobuf::int32 value) {
